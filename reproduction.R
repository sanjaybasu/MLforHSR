...
# NOTE: if you get an error "Error in h2o.deeplearning(x = x, y = y, training_frame = training_frame,  : unused argument (max_confusion_matrix_size = max_confusion_matrix_size)", you need to DOWNLOAD GITHUB, click 'clone' at the h2o-3 repo (https://github.com/h2oai/h2o-3), check out the "h2oEnsemble_v0.1.9" branch from in the GitHub program, cd to the h2o-r/ensemble directory and in your terminal window, type: R CMD install h2oEnsemble-package ; SEE: https://community.h2o.ai/questions/1588/issue-with-dl-h2o-ensembles-and-h2o-last-version.html
